...
}, kicker)), /*#__PURE__*/React.createElement(FadeUp, {
  delay: 120
...
}, title)), sub && /*#__PURE__*/React.createElement(FadeUp, {
  delay: 220
...
const IndustriesHub = () => /*#__PURE__*/React.createElement("section", {
  style: {
    background: TOKENS.white,
    padding: "100px 0",
    borderBottom: `1px solid ${TOKENS.hairline}`
...
}, ind.n, " / 05"), /*#__PURE__*/React.createElement("span", {
  style: {
    fontFamily: "Inter, sans-serif",
    fontSize: 11,
    letterSpacing: "0.20em",
...
}, ind.items.length, " services")), /*#__PURE__*/React.createElement("h2", {
  style: {
    fontFamily: "'Bebas Neue', sans-serif",
    fontSize: 56,
    letterSpacing: "0.02em",
...
}), /*#__PURE__*/React.createElement(IndustriesHub, null)), /*#__PURE__*/React.createElement(Footer, null));
