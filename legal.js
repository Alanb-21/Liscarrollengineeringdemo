...
const PAGES = {
  privacy: {
    ...
    intro: "We respect your privacy. This page sets out what data we collect on liscarrollengineering.ie, why we collect it, and what we do with it.",
    sections: [{
      h: "Who we are",
  ...
  terms: {
    kicker: "Legal",
    title: "Terms of Use",
    intro: "By using liscarrollengineering.ie you agree to the following terms. They are written in plain English.",
    sections: [{
      h: "Use of the site",
...
}, data.kicker)), /*#__PURE__*/React.createElement(FadeUp, {
  delay: 120
...
}, data.title)), /*#__PURE__*/React.createElement(FadeUp, {
  delay: 220
...
}, data.sections.map((s, i) => /*#__PURE__*/React.createElement(FadeUp, {
  key: s.h,
  delay: i * 40
}, /*#__PURE__*/React.createElement("div", {
  style: {
...
}, s.p)))), /*#__PURE__*/React.createElement(FadeUp, {
  delay: data.sections.length * 40
}, /*#__PURE__*/React.createElement("p", {
  style: {
    fontFamily: "Inter, sans-serif",
    fontSize: 13,
...
const App = () => /*#__PURE__*/React.createElement(PageFade, null, /*#__PURE__*/React.createElement(Nav, {
  ...
  id: "main"
}, /*#__PURE__*/React.createElement(Hero, null), /*#__PURE__*/React.createElement(Body, null)), /*#__PURE__*/React.createElement(Footer, null));
