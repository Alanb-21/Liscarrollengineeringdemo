...
const STUDIES = [
  ...
  { client: "Croke Park", n: "02", title: "Tap. Take. Go. bar fabrication", sector: "Bespoke", year: "2021", scale: "12 stations", tone: "navy" },
  { client: "Dale Farm", n: "03", title: "Co-op silo install", sector: "Farming", year: "2023", scale: "60,000 L", tone: "steel" },
  { client: "Hot Box Wellness", n: "04", title: "Plunge pool suite", sector: "Leisure", year: "2025", scale: "8 units", tone: "navy" },
  { client: "Confidential pharma", n: "05", title: "Passivated vessel run", sector: "Pharmaceuticals", year: "2024", scale: "GMP grade", tone: "steel" },
  { client: "Kerry creamery", n: "06", title: "Buffer tank upgrade", sector: "Farming", year: "2022", scale: "40,000 L", tone: "navy" },
];

const Hero = () => (
  <section style={{ background: TOKENS.white, borderBottom: `1px solid ${TOKENS.hairline}`, padding: "100px 0 80px" }}>
    <div style={{ maxWidth: 1440, margin: "0 auto", padding: "0 32px" }}>
      <FadeUp><Kicker style={{ marginBottom: 32 }}>Selected work</Kicker></FadeUp>
      <FadeUp delay={120}>
...
const Grid = () => (
  <section style={{ background: TOKENS.white, padding: "100px 0", borderBottom: `1px solid ${TOKENS.hairline}` }}>
    <div style={{ maxWidth: 1440, margin: "0 auto", padding: "0 32px" }}>
      <div className="industries-hub-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 48 }}>
        {STUDIES.map((s, i) => (
          <FadeUp key={s.client} delay={(i % 2) * 100}>
            <a href="#" style={{ display: "block", textDecoration: "none", color: "inherit" }}
              ...
              <div style={{ paddingTop: 24 }}>
                ...
                <h2 style={{ fontFamily: "'Bebas Neue', sans-serif", fontSize: 44, letterSpacing: "0.02em", color: TOKENS.navy, margin: "0 0 8px 0", textTransform: "uppercase", lineHeight: 1 }}>
                  {s.client}
                </h2>
                <div style={{ fontFamily: "Inter, sans-serif", fontSize: 15, lineHeight: 1.5, color: TOKENS.body, marginBottom: 16 }}>
                  {s.title} · {s.scale}
                </div>
                <span style={{ fontFamily: "Inter, sans-serif", fontSize: 13, fontWeight: 500, color: TOKENS.navy, letterSpacing: "0.10em", textTransform: "uppercase", borderBottom: `1px solid ${TOKENS.steel}`, paddingBottom: 4 }}>
                  Read the study →
                </span>
              </div>
            </a>
